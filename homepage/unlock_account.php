          ...
          <table width="480" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.08);overflow:hidden;max-width:480px;width:100%;">
            ...
            <tr><td style="padding:40px 40px 32px;">
              ...
              <div style="text-align:center;margin:0 0 28px;">
                <a href="{$unlockUrl}" style="display:inline-block;padding:14px 32px;background:#b8860b;color:#fff;text-decoration:none;border-radius:10px;font-size:15px;font-weight:600;">
                  Unlock My Account
                </a>
              </div>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <?php if ($step === 'form'): ?>
      ...
      <p class="subtitle">Enter your email and we'll send you a link to unlock your account and set a new password.</p>
    ...
    <?php elseif ($step === 'sent'): ?>
      ...
      <div class="state-box">
        ...
        <p>
          If a matching account exists, we've sent an unlock link to your inbox.<br>
          The link expires in <strong>30 minutes</strong>.
        </p>
        <p style="font-size:12px;color:var(--gray-400);">
          Didn't receive it? Check your spam folder, or
          <a href="unlock_account.php" style="color:var(--gold);font-weight:600;">try again</a>.
        </p>
      </div>
    ...
    <?php elseif ($step === 'success'): ?>
      ...
      <div class="state-box">
        ...
        <p>Your password has been updated and your account is now unlocked. You can sign in normally.</p>
        <a href="homepage.php" class="btn-primary" style="display:inline-block;width:auto;padding:13px 32px;">
          Go to Sign In
        </a>
      </div>
    ...
    <?php elseif ($step === 'error'): ?>
      ...
      <div class="state-box">
        ...
        <a href="unlock_account.php" class="btn-primary" style="display:inline-block;width:auto;padding:13px 32px;">
          Request New Link
        </a>
      </div>
...
<script>
  ...
  if (resetForm) {
    ...
    resetForm.addEventListener('submit', function(e) {
      ...
      document.getElementById('resetBtn').textContent = 'Saving…';
    });
